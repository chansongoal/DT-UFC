...
def plot_train_loss(train_log_path, train_config):
    ...
    # losses = losses[100:]; mse_losses = mse_losses[100:]; bpp_losses = bpp_losses[100:]; aux_losses = aux_losses[100:]
...
def hyperprior_train_evaluate_pipeline(arch, dataset_root, data_root, source_file, model_type, task, trun_flag, trun_low, trun_high, quant_type, samples, bit_depth, quant_points_name, lambda_value, epochs, save_period, learning_rate, batch_size, patch_size, pretrained_model):
...
def hyperprior_evaluate_pipeline(arch, dataset_root, data_root, source_file, model_type, task, trun_flag, trun_low, trun_high, quant_type, samples, bit_depth, quant_points_name, lambda_value_all, epochs, save_period, learning_rate, batch_size, patch_size, pretrained_model):
    if arch == 'bmshj2018-hyperprior':
        model_name = 'hyperprior'; print(model_name)
    elif arch == 'elic2022-official':
        model_name = 'elic'; print(model_name)
...
if __name__ == "__main__":
    ...
    # hyperprior_train_evaluate_pipeline(arch, dataset_root, data_root, source_file, model_type, task, trun_flag, trun_low, trun_high, quant_type, samples, bit_depth, quant_points_name, lambda_value, epochs, save_period, learning_rate, batch_size, patch_size, pretrained_model)


    # for eval only
    # seg, hyperprior
    # lambda_value_all = [0.00055, 0.0007, 0.0008, 0.001, 0.0015, 0.002, 0.0025, 0.003, 0.004, 0.005, 0.006, 0.007, 0.01, 0.015]
    # seg, elic
    # lambda_value_all = [0.00058, 0.0007, 0.002, 0.003, 0.004, 0.005, 0.007, 0.01]
    # lambda_value_all = [0.0001, 0.00015]
    # hyperprior_evaluate_pipeline(arch, dataset_root, data_root, source_file, model_type, task, trun_flag, trun_low, trun_high, quant_type, samples, bit_depth, quant_points_name, lambda_value_all, epochs, save_period, learning_rate, batch_size, patch_size, pretrained_model)
    
    # # csr, hyperprior
    # lambda_value_all = [0.0003,	0.0005,	0.0008,	0.0013,	0.0015,	0.0017,	0.0019,	0.002,	0.0025,	0.003,	0.0035,	0.006]
    # hyperprior_evaluate_pipeline(arch, dataset_root, data_root, source_file, model_type, task, trun_flag, trun_low, trun_high, quant_type, samples, bit_depth, quant_points_name, lambda_value_all, epochs, save_period, learning_rate, batch_size, patch_size, pretrained_model)
    # csr, elic
    lambda_value_all = [0.0001, 0.0003, 0.0007, 0.001, 0.003, 0.005]
    hyperprior_evaluate_pipeline(arch, dataset_root, data_root, source_file, model_type, task, trun_flag, trun_low, trun_high, quant_type, samples, bit_depth, quant_points_name, lambda_value_all, epochs, save_period, learning_rate, batch_size, patch_size, pretrained_model)
    ...
    # tti, elic
    # lambda_value_all = [0.0002, 0.0005, 0.0007, 0.001, 0.003, 0.005, 0.006, 0.01, 0.02]    # bs=12
    # lambda_value_all = [0.0001]   # bs=24
    # hyperprior_evaluate_pipeline(arch, dataset_root, data_root, source_file, model_type, task, trun_flag, trun_low, trun_high, quant_type, samples, bit_depth, quant_points_name, lambda_value_all, epochs, save_period, learning_rate, batch_size, patch_size, pretrained_model)